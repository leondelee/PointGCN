...
std::vector<std::vector<float>> compute(py::array_t<float> pc, float radius, int num_voxels, float smoothing_kernel_width, const std::vector<int>& interest_point_idxs) {
